import {
    ...
    Clock,
    ObjectLoader,AudioLoader,ImageLoader,TextureLoader,
    Bone,SkeletonHelper,
    AudioListener,
...
let mesh=new BoxMesh(.3,.6,.9,{
    img:'/src/images/trbl.jpg',
    imgSize:.3
});
...
var ambient = new  AmbientLight(0x7777777);
